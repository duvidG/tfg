...
from src.scoring.ska_sdc.common.utils.constants import H_0, Om_lambda, Om_m
...
class ScaleAndCalculateLargestSize(XMatchPreprocessingStep):
    ...
    def execute(self):
        ...
        self.cat["d_a"] = cosmo.angular_diameter_distance(z).values.value
        ...
        da_dfreq = cosmo.angular_diameter_distance(z_dfreq).values.value
